...
public class RoundLinearLayout extends LinearLayout {
    ...
    public RoundLinearLayout(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(
                attrs, R.styleable.RoundLinearLayout, 0, 0);
        backColor = typedArray.getColor(R.styleable.RoundLinearLayout_backColor, Color.TRANSPARENT);
        endColor = typedArray.getColor(R.styleable.RoundLinearLayout_endColor, Color.TRANSPARENT);
        startColor = typedArray.getColor(R.styleable.RoundLinearLayout_startColor, Color.TRANSPARENT);
        borderWidth = (int) typedArray.getDimension(R.styleable.RoundLinearLayout_borderWidth, 0);
        borderColor = typedArray.getColor(R.styleable.RoundLinearLayout_borderColor, Color.TRANSPARENT);
        ...
        radiusRightBottom = typedArray.getDimension(R.styleable.RoundLinearLayout_radiusRightBottom, 0);
        gradientType = typedArray.getInt(R.styleable.RoundLinearLayout_gradientType, 0);
        typedArray.recycle();
        setBackground();
    }

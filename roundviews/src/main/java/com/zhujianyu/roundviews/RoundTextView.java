...
public class RoundTextView extends AppCompatTextView {
    ...
    public RoundTextView(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(
                attrs, R.styleable.RoundTextView, 0, 0);
        backColor = typedArray.getColor(R.styleable.RoundTextView_backColor, Color.TRANSPARENT);
        endColor = typedArray.getColor(R.styleable.RoundTextView_endColor, Color.TRANSPARENT);
        startColor = typedArray.getColor(R.styleable.RoundTextView_startColor, Color.TRANSPARENT);
        borderWidth = (int) typedArray.getDimension(R.styleable.RoundTextView_borderWidth, 0);
        borderColor = typedArray.getColor(R.styleable.RoundTextView_borderColor, Color.TRANSPARENT);
        downColor = typedArray.getColor(R.styleable.RoundTextView_downColor, Color.TRANSPARENT);
        radius = typedArray.getDimension(R.styleable.RoundTextView_radius, 0);
        isRadius = typedArray.getBoolean(R.styleable.RoundTextView_isRadius, false);
        radiusLeftTop = typedArray.getDimension(R.styleable.RoundTextView_radiusLeftTop, 0);
        radiusLeftBottom = typedArray.getDimension(R.styleable.RoundTextView_radiusLeftBottom, 0);
        radiusRightTop = typedArray.getDimension(R.styleable.RoundTextView_radiusRightTop, 0);
        radiusRightBottom = typedArray.getDimension(R.styleable.RoundTextView_radiusRightBottom, 0);
        gradientType = typedArray.getInt(R.styleable.RoundTextView_gradientType, 0);
        typedArray.recycle();
        setBackground();
    }
